            ...
            <div class="row justify-content-center">
                ...
                <form class="mx-1 mx-md-4" action="login" method="post">
                  ...
                  <div class="d-flex flex-row align-items-center mb-4">
                    ...
                    <label class="form-label" for="form3Example1c">Email</label>
                      <input type="email" id="form3Example1c" autocomplete="off" name="email" class="form-control" />
                    </div>
                  </div>
                  ...
                  <div class="d-flex flex-row align-items-center mb-4">
                    ...
                    <label class="form-label" for="form3Example4cd">Password</label>
                      <input type="password" id="form3Example4cd" autocomplete="off" name="password" class="form-control" />
                    </div>
                  </div>
                  ...
                  <div class="form-check d-flex justify-content-center mb-5">
                    ...
                    <label class="form-check-label" for="form2Example3">
                      I agree all statements in <a href="Terms_and_Conditions.jsp">Terms of service</a>
                    </label>
                  </div>
              ...
              <div class="col-md-10 col-lg-6 col-xl-7 d-flex align-items-center order-1 order-lg-2">
                ...
                <img src="images/login.jpg"
                  class="img-fluid" alt="This is a login page">
